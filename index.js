...
const calculateProfitAndLoss=(buyPrice, noOfStocks, sellPrice)=>{
    if(sellPrice>buyPrice){
        ...
        let difflose = buyPrice - sellPrice;
        let lostPercentage = (difflose/buyPrice)*100;
        showOutput(`Oh!!! u made a loss of ${difflose*noOfStocks} Rupees and the loss percent is ${lostPercentage}%`)
        }
    else{
